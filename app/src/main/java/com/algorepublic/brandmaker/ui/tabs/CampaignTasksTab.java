...
public class CampaignTasksTab extends Fragment {
    ...
    public static CampaignTasksTab getInstance() {
        if (fragment == null) {
    ...
    private void setupViewPager() {
        ...
        ((MainActivity) getContext()).setToolBar("Brand Name","Check In 02-08-2019 - 9:00 PM",true);
        adapter.addFragment(CampaignFragment.getInstance(), "Campaign");
        adapter.addFragment(CampaignFragment.getInstance(), "Task");
