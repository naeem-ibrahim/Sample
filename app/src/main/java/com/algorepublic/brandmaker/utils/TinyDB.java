...
import com.algorepublic.brandmaker.model.User;
...
public class TinyDB {
    ...
    public void setUserObg(User userObg) {
        Gson gson = new Gson();
        String json = gson.toJson(userObg);
        preferences.edit().putString("UserOBJ",json).apply();
    }

    public User getUserObj(){
        Gson gson = new Gson();
        String json = preferences.getString("UserOBJ", "");
